...
const SHIP_NAMES = [
  ...
  "Aegean Dream", "Aether", "Agamemnon", "Ajax", "Albacore",
  "Alexandria Belle", "Almeria", "Aloft", "Altair", "Ambergris",
  "Amphora", "Annabelle Lee", "Antares", "Aphrodite", "Apollo's Reach",
  "Aquila", "Aragon", "Ariel", "Armada", "Arrowhead",
  // B
  "Barnacle Bill", "Bay Wanderer", "Black Coral", "Blue Horizon", "Bounty Hunter",
  "Brig of Dawn", "Bristol Belle", "Black Pearl", "Barracuda", "Beacon Fire",
  "Bellatrix", "Bengal Star", "Bianca", "Blue Anchor", "Blue Lagoon",
  "Boreas", "Bosphorus", "Bright Star", "Brine Runner", "Buccaneer",
  // C
  "Cape Endeavour", "Capella", "Celestial Wind", "Channel Rover", "Compass Rose",
  "Copper Sky", "Coral Queen", "Corsair's Dream", "Crimson Sail",
  "Caledonia", "Calypso", "Cambria", "Canopus", "Canterbury Bell",
  "Cape Horn", "Capricorn", "Cargo King", "Carrick", "Carthage",
  "Castor", "Catalina", "Celeste", "Cerulean", "Cetus",
  "Challenger", "Charity", "Chimaera", "Circe", "Citadel",
  // D
  "Dawnbreaker", "Deep Current", "Dockside Dreamer", "Duchess of York",
  "Daedalus", "Danube", "Dark Matter", "Dauntless", "Dawn Patrol",
  "Daybreak", "Dead Reckoning", "Deepwater", "Defiant", "Delphinus",
  "Destiny", "Diamond Shoal", "Diomedes", "Discordia", "Discovery",
  "Dominator", "Driftwood", "Dubrovnik", "Dunmore", "Dusky Sound",
  // E
  "East India Maid", "Endeavour", "Evening Star", "Expedition",
  "Eagle's Wing", "Ebbtide", "Eclipse", "Eddystone", "Elara",
  "Eleanor", "Elysian", "Emissary", "Empire Wind", "Endurance",
  "Equinox", "Erebus", "Espada", "Estuary", "Europa",
  // F
  "Fair Winds", "Far Horizon", "Flying Dutchman", "Foam Crest", "Fortuna", "Free Spirit",
  "Falconer", "Fathom", "Fidelis", "Firebrand", "First Light",
  "Fjord Runner", "Flagship", "Fleur de Lis", "Flint", "Florentine",
  "Forewind", "Formidable", "Fortunata", "Foxhound", "Freebooter",
  // G
  "Gallant Heart", "Gibraltar", "Golden Anchor", "Golden Fleece", "Good Fortune",
  "Grace of the Sea", "Grand Traverse", "Gull's Wing",
  "Galatia", "Galatea", "Ganymede", "Garrison", "Gatekeeper",
  "Gemini", "Genovese", "Glasswater", "Gloria Maris", "Golden Gate",
  "Golden Hind", "Golden Spur", "Gorgon", "Grampus", "Grenadier",
  "Greyhound", "Griffin", "Gryphon", "Guardsman", "Gulf Star",
  // H
  "Harbour Light", "Hermes", "High Tide", "HMS Resolute", "Horizon Chaser",
  "Hannibal", "Harbinger", "Hardwind", "Harmony", "Harpy",
  "Harvest Moon", "Hawksbill", "Heartwind", "Heliodor", "Helios",
  "Hercules", "Hesperus", "Highlander", "Hippolyta", "Hotspur",
  "Hullbreaker", "Huntress", "Hurricane", "Hydra", "Hyperion",
  // I
  "Indigo Passage", "Iron Duke", "Isle Trader",
  "Iberia", "Icarus", "Illusion", "Imperator", "Implacable",
  "Indefatigable", "Indomitable", "Inferno", "Intrepid", "Io",
  "Ionia", "Iona", "Iris", "Iron Horse", "Ironside",
  // J
  "Jade Compass", "Jubilee",
  "Janus", "Jason", "Jericho", "Jezebel", "Jolly Roger",
  "Jonah's Fortune", "Juggernaut", "Juno", "Jupiter's Call",
  // K
  "Kingston Belle",
  "Kestrel", "Kingfisher", "Kittiwake", "Kraken", "Kybele",
  // L
  "Lady of the Mist", "Leviathan", "Lion of the Seas", "Lisbon Star", "Lucky Mariner",
  "La Paloma", "Laconia", "Lagoon", "Lambent", "Lark",
  "Latitude", "Laurentia", "Lazarus", "Leonidas", "Levanter",
  "Leyte", "Libertad", "Lighthouse", "Lindy", "Lionheart",
  // M
  "Maiden Voyage", "Marigold", "Maritime Dream", "Medway Merchant", "Mercury",
  "Midnight Blue", "Misty Harbour", "Monsoon", "Morning Glory",
  "Maelstrom", "Magdalene", "Magellanic", "Magnolia", "Magnus",
  "Makara", "Malacca", "Manticore", "Maranello", "Marauder",
  "Mariana", "Marina", "Mariner", "Marmara", "Marquessa",
  "Martinique", "Masthead", "Matador", "Medusa", "Melisande",
  "Meridian", "Merlin", "Midnight Run", "Minnow", "Mirage",
  "Mistral", "Mnemosyne", "Moonraker", "Mordecai", "Morwenna",
  // N
  "Neptune's Bounty", "Night Passage", "Northern Light",
  "Naiad", "Narwhal", "Nautilus", "Navigator", "Nebula",
  "Nemesis", "Nereid", "Nereus", "Nereide", "Niobe",
  "Nocturne", "Norseman", "North Star", "Northwester", "Nymph",
  // O
  "Ocean Tempest", "Old Salt", "Olympia", "Open Water",
  "Obsidian", "Oceanus", "Odyssey", "Ondine", "Opal",
  "Orca", "Orion", "Orpheus", "Osprey", "Outbound",
  // P
  "Pacific Lass", "Peregrine", "Pilgrim Spirit", "Polaris", "Portsmouth Pride",
  "Privateer", "Providence",
  "Paladin", "Pandora", "Pantheon", "Paragon", "Parity",
  "Pathfinder", "Patroclus", "Pegasus", "Pelican", "Penelope",
  "Perseus", "Petrel", "Phaedra", "Phantom", "Phosphor",
  "Pinto", "Pioneer", "Pirate King", "Piscator", "Pleiades",
  "Plover", "Pluton", "Polyphemos", "Portcullis", "Poseidon",
  "Praxis", "Priscilla", "Prometheus", "Proteus", "Ptolemy",
  // Q
  "Queen of Spades",
  "Quadrant", "Quasar", "Questor", "Quicksilver", "Quill",
  // R
  "Rampant Lion", "Red Ensign", "Resolute", "Rising Sun", "River Dragon",
  "Roaring Forties", "Rogue Wave", "Royal Charter", "Rum Runner",
  "Raider", "Rampart", "Raptor", "Raven", "Rayonnant",
  "Redoubt", "Reef Runner", "Regal", "Relentless", "Renown",
  "Reprisal", "Resolute Star", "Reticent", "Revenant", "Ricochet",
  "Riposte", "Riptide", "Robur", "Rockaway", "Rodney",
  "Roland", "Rosalind", "Roxana", "Royal Flush", "Rudder",
  // S
  "Sable Wind", "Sailor's Delight", "Salt & Pepper", "Sapphire Sky",
  "Sea Breeze", "Sea Hawk", "Sea Serpent", "Seafarer's Joy",
  "Silver Lining", "Sirocco", "South Sea Dreamer", "Sovereign",
  "Spice Trader", "Spirit of Adventure", "Stormbreaker", "Sundown", "Swift Passage",
  "Sable", "Sagitta", "Sagittarius", "Saint Elmo", "Salamander",
  "Saltire", "Salvo", "Samarkand", "Sandpiper", "Santa Cruz",
  "Sardinia", "Sargasso", "Sceptre", "Scorpio", "Scylla",
  "Seaflame", "Seagull", "Seamark", "Seraph", "Sextant",
  "Shearwater", "Signet", "Silhouette", "Skua", "Slipstream",
  "Solent", "Solstice", "Solway", "Sondra", "Sonja",
  "Sorceress", "Soudha", "Sparrowhawk", "Sphinx", "Spitfire",
  "Springtide", "Squadron", "St. Brendan", "Stalwart", "Stamina",
  "Stargazer", "Starhound", "Starlight", "Steadfast", "Stellamare",
  "Stoic", "Stormcloud", "Strait Runner", "Stratagem", "Strider",
  "Strongbow", "Sturmwind", "Subito", "Suez", "Sunfire",
  "Sunrider", "Sunrise", "Sunset", "Surcouf", "Swansong",
  "Swiftsure", "Swordfish", "Sycamore", "Sylla", "Sylph",
  // T
  "Tempest", "The Intrepid", "Tidal Grace", "Trade Wind", "Tradewinds",
  "Triton", "True Compass", "Twilight Voyager", "Two Harbours", "Tyrant Sea",
  "Talon", "Tamarind", "Tamerlane", "Tango", "Tarpon",
  "Tasman", "Tenacious", "Tenedos", "Terra Nova", "Tethys",
  "Thalassa", "Thalia", "Thanatos", "The Bold", "The Daring",
  "The Gallant", "The Hammer", "The Resolute", "The Rover", "The Swift",
  "Theseus", "Thetis", "Thunderclap", "Tidal Force", "Tiderunner",
  "Titan", "Torsion", "Totem", "Tourmaline", "Tradestar",
  "Tradewing", "Trailblazer", "Tramontane", "Traveller", "Trawler King",
  "Trident", "Triumph", "Trophy", "Tropic Star", "Turbine",
  // U
  "Ulysses", "Vagabond",
  "Umbra", "Unicorn", "Union Jack", "Unison", "Unstoppable",
  // V
  "Venture Capital", "Victory", "Viking Spirit",
  "Valiant", "Valor", "Vanguard", "Vega", "Vendetta",
  "Venture", "Venus", "Verity", "Vespera", "Viceroy",
  "Vigilant", "Vigour", "Vindictive", "Viper", "Virago",
  "Virgo", "Viscount", "Vortex", "Vox Populi", "Vulcan",
  // W
  "Wandering Star", "Wayfarer", "West India Queen", "Whispering Wind",
  "Wild Goose", "Windswept", "Windy City", "Wolfhound",
  "Warden", "Warspite", "Watchman", "Waterfront", "Wavecrest",
  "Waverunner", "Wavelength", "Weatherly", "Westerly", "Westward Ho",
  "White Squall", "Whitecap", "Wildfire", "Windlass", "Windward",
  "Winsome", "Wirral", "Witchcraft", "Wraith", "Wyvern",
  // X Y Z
  "Xanthe", "Xebec", "Xenophon",
  "Yarmouth Belle", "Yellow Jack", "Yonder",
  "Zephyr", "Zenith", "Zodiac", "Zulu",
];
